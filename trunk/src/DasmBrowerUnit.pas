...
uses ControlFunctions51, DasmFunctions51, Math, MemoryFunctions51,
  StringFunctions51, IniFiles;
...
begin
  ...
  S := Process_Read(FProcessId, mAddress, vSize);
  if S = '' then Exit;
  DasmToStrings(mAddress, S, FDasmStrings, True, False, FFunctionList);
